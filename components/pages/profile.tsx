...
function ProfileSkeleton() {
    return (
        <main className="mt-(--fd-nav-height) w-full pt-4">
            <section
                className="relative mx-4 overflow-hidden rounded-2xl border border-accent bg-linear-to-b from-muted/30 to-muted/80 md:mx-6">
    ...
    return (
        <Page>
            <PageHeaderHero>
                ...
                {/* Stats */}
                <div
                    className="mt-10 flex items-center justify-center gap-8 rounded-xl border border-border/50 bg-background/50 p-6">
